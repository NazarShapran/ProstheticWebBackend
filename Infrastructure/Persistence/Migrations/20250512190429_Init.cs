    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_amputation_levels", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    amputation_level_id = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_prosthetics", x => x.id);
                    table.ForeignKey(
                        name: "FK_Prosthetics_AmputationLevels",
                        column: x => x.amputation_level_id,
                        principalTable: "amputation_levels",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_prosthetics_amputation_level_id",
                table: "prosthetics",
                column: "amputation_level_id");
